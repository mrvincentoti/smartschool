            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> Applicant Registration
                    </h1>

                    @include('session-messages')

                    <div class="mb-4">
                        <form class="row g-3" action="{{route('applicant.register')}}" method="POST">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Abuja..." required value="{{old('city')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="e.g. Nigeria, Ghana, ..." required value="{{old('nationality')}}">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="inputAssignToClass" class="form-label">Faculty:<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                                    <select onchange="getSections(this);" class="form-select" id="inputAssignToClass" name="class_id" required>
                                ...
                                <div class="col-md-6">
                                    <label for="inputAssignToSection" class="form-label">Department:<sup><i class="bi bi-asterisk text-primary"></i></sup></label>
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-md-3">
                                    <label for="formFile" class="form-label">Waec Result/Neco/Naptep (1st sitting)</label>
                                    <input class="form-control" type="file" id="formFile" onchange="previewWaec1()">
                                    <input type="hidden" id="photoHiddenInput" name="photo" value="">
                                </div>
                                <div class="col-md-3">
                                    <label for="formFile" class="form-label">Waec Result/Neco/Naptep (2nd sitting)</label>
                                    <input class="form-control" type="file" id="formFile" onchange="previewWaec2()">
                                    <input type="hidden" id="photoHiddenInput" name="photo" value="">
                                </div>
                                <div class="col-md-3">
                                    <label for="formFile" class="form-label">Jamb Result</label>
                                    <input class="form-control" type="file" id="formFile" onchange="previewJamb()">
                                    <input type="hidden" id="photoHiddenInput" name="photo" value="">
                                </div>
                                <div class="col-md-3">
                                    <label for="formFile" class="form-label">Others(OND,HND,e.t.c)</label>
                                    <input class="form-control" type="file" id="formFile" onchange="previewJamb()">
                                    <input type="hidden" id="photoHiddenInput" name="photo" value="">
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-12-md">
                                    <button type="submit" class="btn btn-sm btn-outline-danger"><i class="bi bi-person-plus"></i>Save & proceed</button>
                                </div>
                            </div>
                        </form>
                    </div>
