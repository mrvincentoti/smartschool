<div class="col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0">
    <div class="d-flex flex-column align-items-center align-items-sm-start ">
        <ul class="nav flex-column pt-2 w-100">
            ...
            @if(Auth::user()->role == "admin")
            <li class="nav-item">
                <a type="button" href="#fee-submenu" data-bs-toggle="collapse" class="d-flex nav-link {{ request()->is('fees*')? 'active' : '' }}"><i class="bi bi-currency-exchange"></i> <span class="ms-2 d-inline d-sm-none d-md-none d-xl-inline">Fees</span>
                    <i class="ms-auto d-inline d-sm-none d-md-none d-xl-inline bi bi-chevron-down"></i>
                </a>
                <ul class="nav collapse {{ request()->is('fees*')? 'show' : 'hide' }} bg-white" id="fee-submenu">
                    <li class="nav-item w-100" {{ request()->routeIs('fee.list.show')? 'style="font-weight:bold;"' : '' }}><a class="nav-link" href="{{route('fee.list.show')}}"><i class="bi bi-file-text me-2"></i> View Fees</a></li>
                    <li class="nav-item w-100" {{ request()->routeIs('fee.create.show')? 'style="font-weight:bold;"' : '' }}><a class="nav-link" href="{{route('fee.create.show')}}"><i class="bi bi-file-plus me-2"></i> Create Fee</a></li>
                    <li class="nav-item w-100" {{ request()->routeIs('fee.assign.show')? 'style="font-weight:bold;"' : '' }}><a class="nav-link" href="{{route('fee.assign.show')}}"><i class="bi bi-file-plus me-2"></i> Assign Fee</a></li>
                </ul>
            </li>
            @endif
            <li class="nav-item">
